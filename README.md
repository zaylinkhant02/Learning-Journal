...
During Year 7, I began to develop my own simple websites, and also began to learn Python. In Year 8 I learned Bootstrap, some JS, and C. Year 8 was also when I got my 3D printer, and began printing some models from MakerWorld.

At one point I wanted to pursue game development, and I learned some Unity and began 3D modeling in Blender. But I eventually realized I wanted to make physical things, not just digital things, so I switched to Mechatronics. I'm currently in Year 9, learning CAD (fusion 360), embedded C++ and I recently got an ESP32 DevKit V1. I'm continuing my passion, but now I'm designing my own things, not just downloading them from the internet. I plan to expand my skills in the future and eventually build machines and functional assemblies some day.

This repository is my collection of notes, files, and experiments. Most of these are from guides, some of them are my own. It's all things I've done, and will continue to do in the future.
